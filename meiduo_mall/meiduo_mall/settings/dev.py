...
SECRET_KEY = '#qdq&*k-3$ay=8$him&tlz#8lyb7xo2nx9-i_w&yk48_4m$6%7'
...
INSTALLED_APPS = [
    ...
    'haystack',  # elasticsearch引擎操作框架
    'ckeditor',  # 富文本编辑器
    'ckeditor_uploader',  # 富文本编辑器上传图片模块
    'rest_framework',  # drf框架
    'django_crontab',  # 系统定时任务模块
    'pic.apps.PicConfig',
    # 注册子应用
...
EMAIL_PORT = 25
#发送邮件的邮箱
EMAIL_HOST_USER = '884275720@qq.com'
#在邮箱中设置的客户端授权密码
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.199.144:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
